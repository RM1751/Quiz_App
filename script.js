...
const quiz = [
      ...
      {
            // For Pipes And Cisterns button
            question: " pipes A and B together can fill a Tank in 6 hours.If pipe A can fill 5 hours faster than pipe B,in how many hours pipe B alone can fill the tank?",
            opt1: "20",
            opt2: "25",
            opt3: "35",
            opt4: "40",
...
const quizTwo = [
      ...
      {
          // Probability Question button
            question: "What will be the value of P(Tickets numbered 1 to 20 are mixed up and then a ticket is drawn at random. What is the probability that the ticket drawn has a number which is a multiple of 3 or 5? E) if P(E) = 0.07?",
            opt1: "1/2",
            opt2: "2/5",
            opt3: "8/15",
            opt4: "9/5",
      ...
      {
            //      Probability Question button
            question: "bag contains 2 red, 3 green and 2 blue balls. Two balls are drawn at random. What is the probability that none of the balls drawn is blue?",
            opt1: "10/2",
            opt2: "11/21",
            opt3: "4/2",
            opt4: "5/2",
